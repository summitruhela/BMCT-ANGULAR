...
import { ChangeDetectionStrategy, ChangeDetectorRef, Component, EventEmitter, Injectable, Input, NgModule, Output, ViewChild, ViewEncapsulation } from '@angular/core';
    ...
    initializeCrop() {
        setTimeout(() => {
            this._config.crop.forEach((opt, i) => {
                const /** @type {?} */ el = document.getElementById('ngx-crop-img-' + i);
                const /** @type {?} */ options = {};
                if (opt.width) {
...
export { NgxImgComponent, NgxImgCropComponent, NgxImgService, NgxImgModule };
