(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/common'), require('@angular/core'), require('@angular/forms'), require('cropperjs')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/common', '@angular/core', '@angular/forms', 'cropperjs'], factory) :
	(factory((global.ngxImg = {}),global.ng.common,global.ng.core,global.ng.forms,global.cropperjs));
}(this, (function (exports,common,core,forms,Cropper) { 'use strict';
...
var NgxImgService = /** @class */ (function () {
     ...
     * @return {?}
     */
    NgxImgService.prototype.compress = function (src, config, mime_type) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            img.onload = function () {
                ...
                var /** @type {?} */ ctx = cvs.getContext('2d');
                var /** @type {?} */ aspectRatio = img.naturalWidth / img.naturalHeight;
                var /** @type {?} */ maxWidth = config.maxWidth ? config.maxWidth : Infinity;
                var /** @type {?} */ maxHeight = config.maxHeight ? config.maxHeight : Infinity;
                var /** @type {?} */ minWidth = config.minWidth ? config.minWidth : 0;
                var /** @type {?} */ minHeight = config.minHeight ? config.minHeight : 0;
                var /** @type {?} */ width = img.naturalWidth;
                var /** @type {?} */ height = img.naturalHeight;
                ...
                var /** @type {?} */ destX = -width / 2;
                var /** @type {?} */ destY = -height / 2;
                var /** @type {?} */ destWidth = width;
                var /** @type {?} */ destHeight = height;
                cvs.width = width;
                cvs.height = height;
     ...
     * @nocollapse
     */
    NgxImgService.ctorParameters = function () { return []; };
...
var NgxImgComponent = /** @class */ (function () {
    ...
    NgxImgComponent.prototype.validate = function () {
        ...
        if (this._config.fileType.length !== 0 &&
            ...
            this.errors = this.errors.concat([this._errorTexts.fileType]);
        }
        if (this._config.fileSize !== 0 && (this.file.size / 1024) > this._config.fileSize) {
            this.errors = this.errors.concat([this._errorTexts.fileSize.replace('{{ value }}', this.sizeToByte(this._config.fileSize))]);
        }
        if (this._config.minWidth !== 0 && this._config.minWidth >= this.file.width) {
            this.errors = this.errors.concat([this._errorTexts.minWidth.replace('{{ value }}', this._config.minWidth.toString())]);
        }
        if (this._config.maxWidth !== 0 && this._config.maxWidth <= this.file.width) {
            this.errors = this.errors.concat([this._errorTexts.maxWidth.replace('{{ value }}', this._config.maxWidth.toString())]);
        }
        if (this._config.minHeight !== 0 && this._config.minHeight >= this.file.height) {
            this.errors = this.errors.concat([this._errorTexts.minHeight.replace('{{ value }}', this._config.minHeight.toString())]);
        }
        if (this._config.maxHeight !== 0 && this._config.maxHeight <= this.file.height) {
            this.errors = this.errors.concat([this._errorTexts.maxHeight.replace('{{ value }}', this._config.maxHeight.toString())]);
        }
    ...
    NgxImgComponent.prototype.sizeToByte = function (size) {
        var /** @type {?} */ units = ['KB', 'MB', 'GB', 'TB', 'PB', 'EB', 'ZB', 'YB'];
        var /** @type {?} */ i = 0;
        while (size >= 1024) {
            size /= 1024;
            ++i;
...
var NgxImgCropComponent = /** @class */ (function () {
     ...
     * @param {?} _ref
     */
    function NgxImgCropComponent(_service, _ref) {
        this._service = _service;
        this._ref = _ref;
        this.config = {};
    ...
    NgxImgCropComponent.prototype.initializeCrop = function () {
        ...
        setTimeout(function () {
            _this._config.crop.forEach(function (opt, i) {
                var /** @type {?} */ el = document.getElementById('ngx-crop-img-' + i);
                var /** @type {?} */ options = {};
                if (opt.width) {
                ...
                _this.cropper[i] = new Cropper(el, {
                    ...
                    crop: function () {
                        ...
                        _this.timer[i] = setTimeout(function () {
                            _this.onCropEvent(i, _this.cropper[i].getCroppedCanvas(options).toDataURL('image/png'));
                            _this.markForCheck();
                        }, 500);
                    }
                });
    ...
    NgxImgCropComponent.prototype.onCropEvent = function (i, data) {
        ...
        this._service.compress(data, this._config).then(function (res) {
            _this.imgData[i] = res;
            var /** @type {?} */ img = _this.imgData.length === 1 ? _this.imgData[i] : _this.imgData;
...
var NgxImgModule = /** @class */ (function () {
     ...
     * @nocollapse
     */
    NgxImgModule.ctorParameters = function () { return []; };
    return NgxImgModule;
}());
...
exports.NgxImgComponent = NgxImgComponent;
exports.NgxImgCropComponent = NgxImgCropComponent;
exports.NgxImgService = NgxImgService;
exports.NgxImgModule = NgxImgModule;

Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=ngx-img.umd.js.map
